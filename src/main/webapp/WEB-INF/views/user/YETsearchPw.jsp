...
<%!
    public class MyAuthentication extends Authenticator { //아이디 패스워드 인증받기 함수
        ...
        public MyAuthentication(){
            pa=new PasswordAuthentication("itwillbsteam@gmail.com","itwill1234");
        }
        @Override
...
<%
    ...
    //보내는 사람의 정보
    String fromName = "itwillbs";
    String fromEmail = "itwillbsteam@gmail.com";
    ...
    try {
        ...
        msg.setFrom(addr);
        msg.setSubject(MimeUtility.encodeText("8eat pw 찾기", "utf-8","B"));
        msg.setContent("비밀번호 찾기입니다.", "text/html;charset=utf-8");
