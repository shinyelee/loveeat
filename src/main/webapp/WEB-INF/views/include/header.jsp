...
<body>
	...
	<header id="headerBox">
		<div id="topMenu">
			<div class="logoNav"><a href="/"><img src="/resources/img/main/aeat_logo.png"></a></div>
			<nav id="mainMenu" class="nav">
				<ul class="leftSide">
					<li><a href="/intro/Introduce">애잇이란</a></li>
					<li><a href="/recipe/recipeListSearch?num=1">오늘뭐먹지</a>
					</li>
					<li><a href="/store/storeList?num=1">스토어</a></li>
					<li><a href="/tip/listPageSearch?num=1"> 생활노하우</a></li>
					<li><a href="">고객지원</a>
					</li>
				</ul>
				<ul class="rightSide">
					<%
							if(id!=null){
						%>
							<li><span class="gold"><%=nickname %></span>님 환영합니다.</li>
						...
						%>
							<li><a href="/user/login"><i class="fas fa-key normalIcon"></i></a></li>
							<li><a href="/user/insert"><i class="fas fa-user-plus normalIcon"></i></a></li>
							
						<%		
							}
						%>				
					<li><a href="/cart/payment"><i class="fas fa-shopping-cart normalIcon mgt3"></i></a></li>
					<li><i class="fas fa-utensils recipeIcon"></i></li>
					<%
						if(id!=null && id.equals("admin")){
					%>
							<li><a href="/admin/main"><i class="fas fa-user-cog recipeIcon mgt3"></i></a></li>
					<%
						}
				...
				<div id="sliding_menu">
					<div class="section">
						<ul>
							<li><a href="/recipe/recipeList?num=1">애잇이란</a></li>
						</ul>
						<ul>
							<li><a href="/recipe/recipeListSearch?num=1">오늘뭐먹지</a></li>
							<li><a href="/Recipe_review/listPageSearch?num=1">레시피후기</a></li>
						</ul>
						<ul>
							<li><a href="/store/storeList?num=1">상품보기</a></li>
							<li><a href="/store_review/listAll2?num=1">스토어 후기</a></li>
						</ul>				  
						<ul>
							<li><a href="/tip/listPageSearch?num=1"> 생활노하우</a></li>
						</ul>				  
						<ul>
							<li><a href="/qna/board">공지사항</a></li>
							<li><a href="/qna/listpage">QNA</a></li>
							<li><a href="/echo/chat">Live Chat</a></li>
						</ul>
					</div>
				</div>
			</nav>
