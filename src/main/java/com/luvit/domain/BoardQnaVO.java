...
public class BoardQnaVO {
	...
	public String toString() {
		return "BoardQnaVO [q_bno=" + q_bno + ", q_nickname=" + q_nickname + ", q_subject=" + q_subject
				+ ", q_contents=" + q_contents + ", q_file=" + q_file + ", q_date=" + q_date + ", q_hit=" + q_hit
				+ ", q_secret=" + q_secret + ", q_pw=" + q_pw + ", q_re_ref=" + q_re_ref + ", q_re_lev=" + q_re_lev
				+ ", q_re_seq=" + q_re_seq + "]";
	}
}
